...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference('Resource.count') do
      post resources_url, params: { resource: { code: @resource.code, name: @resource.name, resourcetype: @resource.resourcetype } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { code: @resource.code, name: @resource.name, resourcetype: @resource.resourcetype } }
